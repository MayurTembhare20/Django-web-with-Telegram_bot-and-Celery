...
from telegram_bot.models import UserDetails
import logging
from telegram import Update
from telegram import Updater, CommandHandler, CallbackContext,ApplicationBuilder
from dotenv import load_dotenv

async def start(update: Update, context: CallbackContext) -> None:
    user_id = update.effective_user.id
    try:
        user_data = await sync_to_async(UserDetails.objects.get)(id=user_id)
